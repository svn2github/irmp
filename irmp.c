 ...
 *
 * $Id: irmp.c,v 1.16 2010/04/12 13:26:46 fm Exp $
 *
 * ATMEGA88 @ 8 MHz
 *
...
#define NUBERT_START_BIT_PAUSE_LEN_MIN          (uint8_t)(F_INTERRUPTS * NUBERT_START_BIT_PAUSE_TIME * MIN_TOLERANCE_40 + 0.5)
#define NUBERT_START_BIT_PAUSE_LEN_MAX          (uint8_t)(F_INTERRUPTS * NUBERT_START_BIT_PAUSE_TIME * MAX_TOLERANCE_40 + 0.5)
#define NUBERT_1_PULSE_LEN_MIN                  (uint8_t)(F_INTERRUPTS * NUBERT_1_PULSE_TIME * MIN_TOLERANCE_40 + 0.5)
#define NUBERT_1_PULSE_LEN_MAX                  (uint8_t)(F_INTERRUPTS * NUBERT_1_PULSE_TIME * MAX_TOLERANCE_40 + 0.5)
#define NUBERT_1_PAUSE_LEN_MIN                  (uint8_t)(F_INTERRUPTS * NUBERT_1_PAUSE_TIME * MIN_TOLERANCE_40 + 0.5)
#define NUBERT_1_PAUSE_LEN_MAX                  (uint8_t)(F_INTERRUPTS * NUBERT_1_PAUSE_TIME * MAX_TOLERANCE_40 + 0.5)
#define NUBERT_0_PULSE_LEN_MIN                  (uint8_t)(F_INTERRUPTS * NUBERT_0_PULSE_TIME * MIN_TOLERANCE_40 + 0.5)
